    ...
    return (
        <div className="flex flex-col space-y-6 select-none">
            ...
            <p className="text-xs font-light">
                Measure social media performance, create great reports, and get and <br /> recommend recommendations t
                o increase reach, engagement and sales.
            </p>

            <div className="flex gap-6">
                <Button className="hover:bg-transparent hover:text-[#6841DA]" variant={"secondary"} size={"lg"}>
                    Get started now
                </Button>
